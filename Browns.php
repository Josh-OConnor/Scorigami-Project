...
$q1 = "SELECT * FROM `Browns` WHERE `Scorigami` = 1 AND `W-Team` = 'Cleveland Browns' ";
...
$q = "SELECT * FROM `Browns` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
