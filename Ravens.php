...
$q1 = "SELECT * FROM `Ravens` WHERE `Scorigami` = 1 AND `W-Team` = 'Baltimore Ravens' ";
...
$q = "SELECT * FROM `Ravens` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
