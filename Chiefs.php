...
$q1 = "SELECT * FROM `Chiefs` WHERE `Scorigami` = 1 AND `W-Team` = 'Kansas City Chiefs' ";
...
$q = "SELECT * FROM `Chiefs` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
