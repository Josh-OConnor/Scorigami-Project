...
$q1 = "SELECT * FROM `Giants` WHERE `Scorigami` = 1 AND `W-Team` = 'New York Giants' ";
...
$q = "SELECT * FROM `Giants` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
