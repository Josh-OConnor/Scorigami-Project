...
$q1 = "SELECT * FROM `Bengals` WHERE `Scorigami` = 1 AND `W-Team` = 'Cincinnati Bengals' ";
...
$q = "SELECT * FROM `Bengals` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
