...
$q1 = "SELECT * FROM `steelers` WHERE `Scorigami` = 1 AND `W-Team` = 'Pittsburgh Steelers' ";
...
$q = "SELECT * FROM `steelers` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
