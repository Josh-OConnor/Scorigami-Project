...
$q1 = "SELECT * FROM `Saints` WHERE `Scorigami` = 1 AND `W-Team` = 'New Orleans Saints' ";
...
$q = "SELECT * FROM `Saints` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
