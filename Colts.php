...
$q1 = "SELECT * FROM `Colts` WHERE `Scorigami` = 1 AND `W-Team` IN ('Indianapolis Colts', 'Baltimore Colts') ";
...
$q = "SELECT * FROM `Colts` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
