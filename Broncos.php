...
$q1 = "SELECT * FROM `Broncos` WHERE `Scorigami` = 1 AND `W-Team` = 'Denver Broncos' ";
...
$q = "SELECT * FROM `Broncos` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
