...
$q1 = "SELECT * FROM `Jags` WHERE `Scorigami` = 1 AND `W-Team` = 'Jacksonville Jaguars' ";
...
$q = "SELECT * FROM `Jags` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
