...
$q1 = "SELECT * FROM `Chargers` WHERE `Scorigami` = 1 AND `W-Team` IN ('Los Angeles Chargers', 'San Diego Chargers') ";
...
$q = "SELECT * FROM `Chargers` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
