...
$q1 = "SELECT * FROM `Panthers` WHERE `Scorigami` = 1 AND `W-Team` = 'Carolina Panthers' ";
...
$q = "SELECT * FROM `Panthers` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
