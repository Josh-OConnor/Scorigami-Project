...
$q1 = "SELECT * FROM `Eagles` WHERE `Scorigami` = 1 AND `W-Team` = 'Philadelphia Eagles' ";
...
$q = "SELECT * FROM `Eagles` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
