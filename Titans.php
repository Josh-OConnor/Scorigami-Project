...
$q1 = "SELECT * FROM `Titans` WHERE `Scorigami` = 1 AND `W-Team` IN ('Tennessee Titans', 'Houston Oilers') ";
...
$q = "SELECT * FROM `Titans` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
