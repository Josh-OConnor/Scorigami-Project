...
$q1 = "SELECT * FROM `New England` WHERE `Scorigami` = 1 AND `W-Team` = 'New England Patriots' ";
...
$q = "SELECT * FROM `New England` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
