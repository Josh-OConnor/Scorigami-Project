...
$q1 = "SELECT * FROM `49ers` WHERE `Scorigami` = 1 AND `W-Team` = 'San Francisco 49ers' ";
...
$q = "SELECT * FROM `49ers` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
