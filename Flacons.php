...
$q1 = "SELECT * FROM `Falcons` WHERE `Scorigami` = 1 AND `W-Team` = 'Atlanta Falcons' ";
...
$q = "SELECT * FROM `Falcons` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
