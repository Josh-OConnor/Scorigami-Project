...
$q1 = "SELECT * FROM `Raiders` WHERE `Scorigami` = 1 AND `W-Team` IN ('Las Vegas Raiders','Oakland Raiders', 'Los Angelos Raiders') ";
...
$q = "SELECT * FROM `Raiders` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
