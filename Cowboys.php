...
$q1 = "SELECT * FROM `Cowboys` WHERE `Scorigami` = 1 AND `W-Team` = 'Dallas Cowboys' ";
...
$q = "SELECT * FROM `Cowboys` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
