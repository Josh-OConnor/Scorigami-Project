...
$q1 = "SELECT * FROM `Rams` WHERE `Scorigami` = 1 AND `W-Team` IN ('Los Angeles Rams', 'St. Louis Rams') ";
...
$q = "SELECT * FROM `Rams` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
