...
$q1 = "SELECT * FROM `seattle` WHERE `Scorigami` = 1 AND `W-Team` = 'Seattle Seahawks' ";
...
$q = "SELECT * FROM `seattle` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
