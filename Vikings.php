...
$q1 = "SELECT * FROM `Vikings` WHERE `Scorigami` = 1 AND `W-Team` = 'Minnesota Vikings' ";
...
$q = "SELECT * FROM `Vikings` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
