...
$q1 = "SELECT * FROM `Packers` WHERE `Scorigami` = 1 AND `W-Team` = 'Green Bay Packers' ";
...
$q = "SELECT * FROM `Packers` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
