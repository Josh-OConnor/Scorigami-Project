...
$q1 = "SELECT * FROM `Commanders` WHERE `Scorigami` = 1 AND `W-Team` IN ('Washington Redskins', 'Washington Football Team', 'Washington Commanders') ";
...
$q = "SELECT * FROM `Commanders` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
