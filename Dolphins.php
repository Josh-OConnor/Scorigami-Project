...
$q1 = "SELECT * FROM `Dolphins` WHERE `Scorigami` = 1 AND `W-Team` = 'Miami Dolphins' ";
...
$q = "SELECT * FROM `Dolphins` WHERE `Scorigami` > 1 ORDER BY `Scorigami` ASC";
